...
func _ready():
	...
	print("Fita: ", nome_fita, " | fita_anterior: '", fita_anterior, "' | itens_coletados: ", SaveManager.itens_coletados, " | tem a anterior? ", SaveManager.itens_coletados.has(fita_anterior))
